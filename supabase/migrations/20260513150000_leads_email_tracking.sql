-- S3/A2: Email tracking columns for lead magnet delivery pipeline
-- Issue: #1171 - feat(leads): adicionar colunas de rastreamento de email
...
-- Partial index: only rows awaiting first delivery attempt
